...
@section('content')
    ...
    <div class="w-full bg-base-200 ">
        <div class="overflow-x-auto">
            <div class="py-4 px-4">
                <a class="btn btn-outline btn-success" href="{{ route('form/kamar/add') }}">
            ...
            <table class="table text-xl text-center" compact>
                ...
                @foreach($kamar as $data)
                    <tr> 
                        <td class="room_id">{{$data->room_id}}</td>
            ...
            <div class="modal" role="dialog">
                <div class="modal-box">
                    <form action="{{ route('form/kamar/delete') }}" method="POST">
                    @csrf
                        ...
                        <div class="modal-action">
                            ...
                            <input class="form-control" type="hidden" id="e_room_id" name="room_id" value="">
            ...
            {{-- end delete model --}}
                ...
                <script>
                    $(document).on('click','.delete_asset',function()
                    {
                        ...
                        $('#e_room_id').val(_this.find('.room_id').text());
                    });
                </script>
            @endsection
