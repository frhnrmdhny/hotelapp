        ...
        <div class="overflow-x-auto">
            ...
            <table class="table text-xl text-center" compact>
                ...
                <tbody>
                        ...
                        <tr> 
                            <td class="booking_id">{{$data->booking_id}}</td>
                            <td>{{$data->room_id}}</td>
                            <td>{{$data->checkin}}</td>
                            <td>{{$data->checkout}}</td>
                            <!-- <td>500</td> -->
                ...
                <div class="modal-box">
                    ...
                    @csrf
                        ...
                        <div class="modal-action">
                            ...
                            <input class="form-control" type="hidden" id="e_booking_id" name="booking_id" value="">
            ...
            {{-- end delete model --}}
                ...
                <script>
                    $(document).on('click','.delete_asset',function()
                    {
                        ...
                        $('#e_booking_id').val(_this.find('.booking_id').text());
                    });
                </script>
            @endsection
