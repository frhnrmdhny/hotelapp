                        ...
                        <div class="row formtype">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input name="staff_id" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
                             <div class="col-md-8">
                                <div class="form-group">
                                    <label for="namaDepan">Nama Depan</label>
                                    <input id="namaDepan" name="namaDepan" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
                             <div class="col-md-8">
                                <div class="form-group">
                                    <label for="namaBelakang">Nama Belakang</label>
                                    <input id="namaBelakang" name="namaBelakang" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="gaji">Gaji Staff</label>
                                    <input id="gaji" name="gaji" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
                              <div class="col-md-8">
                                <div class="form-group">
                                    <label for="ttl">Tanggal Lahir</label>
                                    <input id="ttl" name="ttl" class="form-control" type="date" value="" required> 
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="no_phone">No Telepon</label>
                                    <input id="no_phone" name="no_phone" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
