    ...
    <div class="hero min-h-screen bg-base-200">
        <div class="hero-content flex-col lg:flex-row-reverse">
            <div class="card shrink-0 w-full shadow-2xl bg-base-100">
                <form class="card-body" action="{{ route('form/staff/save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-control" >
                        ...
                        <input name="staff_id" type="text" placeholder="Jhon Doe" class="input input-bordered" required />
                    </div>
                    <div class="form-control" >
                        <label class="label" for="namaDepan">
                            <span class="label-text">First Name</span>
                        </label>
                        <input id="namaDepan" name="namaDepan" type="text" placeholder="Jhon Doe" class="input input-bordered" required />
                    </div>
                    <div class="form-control" >
                        <label class="label" for="namaBelakang">
                            <span class="label-text">Last Name</span>
                        </label>
                        <input id="namaBelakang" name="namaBelakang" type="text" placeholder="Jhon Doe" class="input input-bordered" required />
                    </div>
                    <div class="form-control">
