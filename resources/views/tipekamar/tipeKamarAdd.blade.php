...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ route('form/tpKamar/save') }}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row formtype">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input name="roomType_id" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
                             <div class="col-md-8">
                                <div class="form-group">
                             ...
                             <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input id="hargaPerMalam" name="hargaPerMalam" class="form-control" type="text" value="" required> 
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="kapasitas">Maksimal Kapasitas Tamu</label>
                                    <input id="kapasitas" name="kapasitas" class="form-control" type="number" value="" required> 
                                </div>
                            </div>
                             <div class="col-md-8">
                                <div class="form-group">
